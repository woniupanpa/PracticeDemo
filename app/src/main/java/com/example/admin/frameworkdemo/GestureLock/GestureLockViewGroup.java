...
public class GestureLockViewGroup extends RelativeLayout
{
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec)
    {
        ...
        // Log.e(TAG, mWidth + "");
        // Log.e(TAG, mHeight + "");
        Log.d("yjm", "mWidth--->"+mWidth);//720
        Log.d("yjm", "mHeight--->"+mHeight);//1230
        ...
        if (mGestureLockViews == null)
        {
            ...
            Log.d("yjm", "mGestureLockViewWidth--->"+mGestureLockViewWidth);//137
            Log.d("yjm", "mMarginBetweenLockView--->"+mMarginBetweenLockView);//34
